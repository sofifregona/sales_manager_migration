...
import { createPaymentMethod } from "~/feature/paymentMethod/payment-method-api.server";
import type { CreatePaymentMethodPayload } from "~/feature/paymentMethod/payment-method";
...
export async function handlePaymentMethodCreate({ url, formData }: Ctx) {
  ...
  const payload: CreatePaymentMethodPayload = { name, idAccount };
  try {
