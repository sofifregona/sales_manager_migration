...
import { deactivatePaymentMethod } from "~/feature/paymentMethod/payment-method-api.server";
...
export async function handlePaymentMethodDeactivate({ url, formData }: Ctx) {
