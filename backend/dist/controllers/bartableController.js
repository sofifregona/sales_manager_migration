import { createBartable, getAllBartables, getBartableById, updateBartable, } from "../services/bartableService.js";
import { AppError } from "../errors/AppError.js";
export const createBartableHandler = async (req, res) => {
    try {
...
export const updateBartableHandler = async (req, res) => {
...
export const deactivateBartableHandler = async (req, res) => {
    const id = parseInt(req.params.id, 10);
    try {
...
export const getAllBartablesHandler = async (_req, res) => {
    try {
...
export const getBartableByIdHandler = async (req, res) => {
    const id = parseInt(req.params.id, 10);
    try {
