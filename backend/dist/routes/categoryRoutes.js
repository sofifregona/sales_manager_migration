...
import { createCategoryHandler, getAllCategoriesHandler, getCategoryByIdHandler, deactivateCategoryHandler, updateCategoryHandler, } from "../controllers/categoryController.js";
const router = Router();
