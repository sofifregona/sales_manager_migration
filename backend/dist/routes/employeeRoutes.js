...
import { createEmployeeHandler, getAllEmployeesHandler, getEmployeeByIdHandler, deactivateEmployeeHandler, updateEmployeeHandler, } from "../controllers/employeeController.js";
const router = Router();
